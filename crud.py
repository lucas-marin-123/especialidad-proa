...
def main_app():
    ...
    btn_duplicate = tk.Button(root, text="Duplicar Cantidad", command=duplicate_quantity)
    btn_duplicate.grid(row=7, column=0, columnspan=2)

    # Lista de items
    listbox_items = tk.Listbox(root)
    listbox_items.grid(row=8, column=0, columnspan=2)
